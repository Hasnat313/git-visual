...
export const BASE_URL = "https://git-visual-backend-public-production.up.railway.app/v1";

export const BASE_URL_IMG = "https://git-visual-backend-public-production.up.railway.app/";
...
export const BASE_URL_SOCKET_LOCAL = "http://localhost:3000";