import { Row, Col, Avatar, Dropdown, Space, Input, Select, Image, Typography, Button, Divider } from "antd";
	...
	return (
		...
		>
			...
			<Col md={{ span: 4 }} lg={{ span: 4 }} xl={{ span: 4 }}>
				<Col>
					<Input className="search" placeholder="Search Community" prefix={<SearchOutlined />} />
				</Col>
			</Col>

			<Col md={{ span: 8 }} lg={{ span: 8 }} xl={{ span: 8 }} style={{ textAlign: "center" }}>
				<Link to="/">
			...
			<Col md={{ span: 8 }} lg={{ span: 8 }} xl={{ span: 8 }}>
				<Row align="middle" justify="end" style={{ overflow: "hidden", width: "100%" }}>
              ...
              <BellIcon />
						...
						<Col>
							<Link to="/profile">
								<Avatar icon={<UserOutlined />} src="https://joeschmoe.io/api/v1/random" />
							</Link>
						</Col>
